...
PROFILES = {
    "SIM-A": (10.0, [1, 1.05, 1.25, 1.25, 2.2, 2.0, 2.9, 2.4, 2.9, 3.2, 2.2], .025, .013),
    "SIM-B": (8.0, [1, .95, .85, .75, 1.2, 1.45, 1.65, 1.3, 1.65, 1.75, 1.65], .04, .012),
    "SIM-C": (3.0, [1, 1.1, 1.5, 2.1, 3.2, 4.8, 6.3, 4.9, 5.6, 6.6, 7.2], .02, .014),
    "SIM-D": (4.0, [1, .85, .6, .38, .4, .35, .4, .23, .2, .3, .4], .015, .018),
    "SIM-E": (13.0, [1, 1.2, 1.4, 1.45, 1.4, 1.5, 1.55, 1.3, 1.4, 1.2, .95], .035, .012),
    "SIM-F": (4.0, [1, 1.1, 1.2, 1.1, 1.6, 1.65, 1.9, 1.6, 1.75, 1.9, 1.85], .015, .011),
}
